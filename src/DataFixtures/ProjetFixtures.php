...
class ProjetFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $projet->setDescriptionHome('Petit description courte');
        ...
        à manger/séjour très aérien avec une belle superficie (environ 70 m²). L'entrée a été travaillé afin de ne 
